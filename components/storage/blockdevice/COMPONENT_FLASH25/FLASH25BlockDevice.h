...
#ifndef MBED_FLASH25_BLOCK_DEVICE_H
#define MBED_FLASH25_BLOCK_DEVICE_H
...
/** BlockDevice for AT25S flash devices
 *
 *  @code
 *  // Here's an example using the AT45DB on the K64F
 *  #include "mbed.h"
 *  #include "AT25SBlockDevice.h"
 *
 ...
 *  DataFlashBlockDevice dataflash2(PTE2, PTE4, PTE1, PTE5, 400000, PTE6);
 *
 *  int main() {
...
//#define MBED_CONF_FLASH25_SPI_FREQ 4000000

class FLASH25BlockDevice : public mbed::BlockDevice {
public:
     ...
     */
    FLASH25BlockDevice(PinName mosi,
                         PinName miso,
                         PinName sclk,
                         PinName csel,
                         int freq = MBED_CONF_FLASH25_SPI_FREQ,
                         PinName nowp = NC);
...
#endif  /* MBED_AT25S_BLOCK_DEVICE_H */
