...
#define USE_SYSCLOCK_168 (0) /* Use external 8MHz or 12 MHz xtal and sets SYSCLK to 168MHz */
#define USE_SYSCLOCK_84 (0) /* Use external 8MHz or 12 MHz xtal and sets SYSCLK to 84MHz */
#define USE_SYSCLOCK_180 (0) /* Use external 25MHz xtal and sets SYSCLK to 180MHz */
#define USE_SYSCLOCK_120 (1) /* Use external 25MHz xtal and sets SYSCLK to 120MHz (USE_USB)*/
