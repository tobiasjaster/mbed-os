...
#elif defined(TARGET_HOMEAUTOMATISIERUNG)
    __HAL_RCC_GPIOA_CLK_ENABLE();
    pin_function(USB_OTG_FS_DM, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_OTG_FS)); // DM
    pin_function(USB_OTG_FS_DP, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_OTG_FS)); // DP
    pin_function(USB_OTG_FS_VBUS, STM_PIN_DATA(STM_MODE_INPUT, GPIO_NOPULL, GPIO_AF10_OTG_FS));  // VBUS
    pin_function(USB_OTG_FS_ID, STM_PIN_DATA(STM_MODE_AF_OD, GPIO_PULLUP, GPIO_AF10_OTG_FS)); // ID
    __HAL_RCC_USB_OTG_FS_CLK_ENABLE();
